...
export const CarSearch = ({ style, className }) => {
  ...
  console.log("Data Form Car Query", data, loading, error);
            ...
            >
              ...
              <div className="my-2 justify-between gap-2 font-heading text-xl font-bold lg:flex">
                ...
                <div className="text-right">
                  <div className="inline-block whitespace-nowrap bg-emerald-900 py-2 px-4 text-white">
