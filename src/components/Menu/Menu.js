...
export const Menu = () => {
  ...
  `);
  console.log("Main Meni", data);
  const { menuItems } = data.wp.acfOptionsMainMenu.menuMenu;

  return (
    <div className="sticky top-0 z-20 flex h-16 items-center justify-between bg-gradient-to-tr from-british-green to-emerald-900 px-4 font-bold text-white">
      <Link to="/">
        <StaticImage
          src="../../../static/icon.png"
          layout="fixed"
